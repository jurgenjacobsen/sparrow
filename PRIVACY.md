...
This Privacy Policy describes how your data is handled by the **Sparrow** Chrome Extension (the "Extension"). 

## 1. Our Privacy Philosophy
We believe that productivity tools should respect user privacy. **Sparrow is designed to be a private, local-first tool.** ## 2. Data Collection
**Sparrow does not collect, store, or transmit any personal data.**
